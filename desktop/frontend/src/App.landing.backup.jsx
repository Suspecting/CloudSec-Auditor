...
function Navbar() {
  ...
  return (
    <motion.nav
      animate={{
        width: scrolled ? "min(780px, calc(100% - 32px))" : "min(1160px, calc(100% - 32px))",
        y: scrolled ? 12 : 24,
...
function CommandCenter() {
  return (
    <div className="glass-strong rounded-[2rem] p-5">
      ...
      <button className="group mt-5 flex w-full items-center justify-center gap-2 rounded-2xl bg-cyan-300 px-6 py-4 font-black text-slate-950 shadow-2xl shadow-cyan-500/20 transition hover:bg-cyan-200">
...
function FindingsTable() {
  return (
    <div id="findings" className="glass-strong rounded-[2rem] p-5">
      <div className="mb-5 flex flex-col justify-between gap-4 border-b border-white/10 pb-4 md:flex-row md:items-center">
        <div>
      ...
      <div className="overflow-hidden rounded-2xl border border-white/10">
        <div className="grid grid-cols-[0.8fr_0.9fr_1.5fr_1.2fr_0.8fr] bg-white/[0.04] px-4 py-3 text-xs font-black uppercase tracking-[0.16em] text-slate-500">
          <span>Severity</span>
          <span>Service</span>
          <span>Issue</span>
          <span>Resource</span>
        ...
        {findings.map((finding) => (
          <div
            key={finding.id}
            className="grid grid-cols-[0.8fr_0.9fr_1.5fr_1.2fr_0.8fr] items-center border-t border-white/10 px-4 py-4 text-sm transition hover:bg-white/[0.035]"
          >
...
function ControlCoverage() {
  return (
    <div id="controls" className="grid gap-4 lg:grid-cols-4">
      {controls.map((control) => {
        ...
        return (
          <div key={control.title} className="glass rounded-[1.75rem] p-5">
            <div className="mb-5 flex items-center justify-between">
...
function ReportPanel() {
  return (
    <div id="reports" className="glass-strong grid overflow-hidden rounded-[2rem] lg:grid-cols-[0.85fr_1.15fr]">
...
function App() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      <div className="fixed inset-0 z-[1] noise-layer opacity-60" />
      ...
      <section id="overview" className="relative z-10 mx-auto min-h-screen max-w-7xl px-6 pb-16 pt-36">
        <div className="mb-8 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            ...
            <h1 className="max-w-5xl text-5xl font-black leading-[0.96] tracking-tight text-white md:text-7xl">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 pb-24 pt-12">
        <div id="workflow" className="grid gap-5 md:grid-cols-3">
